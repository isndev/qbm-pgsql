...
#ifndef QBM_PGSQL_NOT_QB_MD5_H
#define QBM_PGSQL_NOT_QB_MD5_H
...
public:
    ...
    public:
        ...
        void
        reset(const value_type &a_value) {
...
std::istream &operator>>(std::istream &s, md5::digest_type &a);

inline bool
operator==(const md5::digest_type &a, const md5::digest_type &b) {
