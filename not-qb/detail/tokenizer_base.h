...
enum token_type { NoToken, LiteralToken, SingleQuotedToken, DoubleQuotedToken };
...
private:
    virtual void get_token(token &tok) = 0;
...
template <typename InputIterator>
using single_quoted_literal =
    quoted_literal<InputIterator, SINGLE_QUOTE, SingleQuotedToken>;
template <typename InputIterator>
using double_quoted_literal =
    quoted_literal<InputIterator, DOUBLE_QUOTE, DoubleQuotedToken>;
