...
#ifndef QBM_PGSQL_NOT_QB_PROTOCOL_H
#define QBM_PGSQL_NOT_QB_PROTOCOL_H
...
public:
    ...
    message_tag tag() const; /**< PostgreSQL message tag */

    size_type length() const; /**< Length encoded in payload, bytes 1-4 */
...
struct row_data {
    ...
    bool empty() const; /**< Is the row empty */
...
#endif // QBM_PGSQL_NOT_QB_PROTOCOL_H
