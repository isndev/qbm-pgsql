<!-- Verified-against: qb 3.2.0 (C++20 default, C++23 supported) -->

# Support

How to get help with qbm-pgsql, and what to expect.

qbm-pgsql is a module of the [qb actor framework](https://github.com/isndev/qb). Anything about the
...
| **Issues in this repository** | Reproducible bugs and concrete feature requests **in qbm-pgsql**. |
...
3. Prepare a minimal reproduction and your environment: OS, compiler and version, qb version, build
   flags. Say which PostgreSQL server version you reached, how it was started, and whether the connection used TLS.
...
qbm-pgsql is open-source software maintained on a best-effort basis, on the same terms as qb: building
