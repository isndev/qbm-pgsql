...
protected:
    ...
    template<typename T>
    std::vector<qb::pg::byte> createBinaryBuffer(T value) {
    ...
    std::vector<qb::pg::byte> createPgBinaryString(const std::string& value) {
        std::vector<qb::pg::byte> buffer;
    ...
    void printBuffer(const std::vector<qb::pg::byte>& buffer, const std::string& label) {
...
TEST_F(ParamUnserializerTest, MalformedData) {
    ...
    std::vector<qb::pg::byte> randomBuffer = {
        static_cast<qb::pg::byte>(0xAA), 
        static_cast<qb::pg::byte>(0xBB), 
        static_cast<qb::pg::byte>(0xCC), 
        static_cast<qb::pg::byte>(0xDD), 
        static_cast<qb::pg::byte>(0xEE), 
        static_cast<qb::pg::byte>(0xFF), 
        static_cast<qb::pg::byte>(0x11), 
        static_cast<qb::pg::byte>(0x22)
    };
...
TEST_F(ParamUnserializerTest, RealWorldPgIntegration) {
    ...
    struct TestCase {
        ...
        TestCase(const std::string& desc, const std::string& text_value, 
            ...
            : description(desc), is_numeric(numeric) {
    ...
    // 1. Chaîne simple
    {
        ...
        test_cases.emplace_back("Simple text string", 
                               value, 
    ...
    {
        std::string value = "";
        test_cases.emplace_back("Empty string", 
                               value, 
    ...
    // 3. Chaîne avec caractères spéciaux
    {
        ...
        test_cases.emplace_back("String with special chars", 
                               value, 
                               std::vector<qb::pg::byte>(value.begin(), value.end()));
    }
    ...
    // 4. Chaîne avec caractères Unicode
    {
        ...
        test_cases.emplace_back("String with Unicode", 
                               value, 
                               std::vector<qb::pg::byte>(value.begin(), value.end()));
    }
...
TEST_F(ParamUnserializerTest, ExtendedCharacterSetDeserialization) {
    ...
    std::vector<std::string> testStrings = {
        specialChars, unicodeChars, mixedChars, emoji
    };
...
TEST_F(ParamUnserializerTest, CorruptedBufferHandling) {
    ...
    std::vector<qb::pg::byte> randomBuffer = {
        static_cast<qb::pg::byte>(0xDE), 
        static_cast<qb::pg::byte>(0xAD), 
        static_cast<qb::pg::byte>(0xBE), 
        static_cast<qb::pg::byte>(0xEF)
    };
...
// Test complet simulant des cycles de sérialisation/désérialisation comme dans un vrai protocole PostgreSQL
TEST_F(ParamUnserializerTest, CompleteFormatCycle) {
    ...
    std::vector<TestData> testCases = {
        ...
        {
            "smallint",
            std::vector<qb::pg::byte>{'1', '2', '3', '4', '5'}, // "12345" en TEXT
            [&]() {
                smallint val = 12345;
        ...
        {
            "integer",
            std::vector<qb::pg::byte>{'9', '8', '7', '6', '5', '4', '3', '2', '1'}, // "987654321" en TEXT
            [&]() {
        ...
        {
            "bigint",
            std::vector<qb::pg::byte>{'9', '2', '2', '3', '3', '7', '2', '0', '3', '6', '8', '5', '4', '7', '7', '5', '8', '0', '7'}, // Valeur maximale TEXT
            [&]() {
        ...
        {
            "float",
            std::vector<qb::pg::byte>{'3', '.', '1', '4', '1', '5', '9'}, // "3.14159" en TEXT
            [&]() {
                float val = 3.14159f;
                uint32_t bits;
        ...
        {
            "double",
            std::vector<qb::pg::byte>{'2', '.', '7', '1', '8', '2', '8', '1', '8', '2', '8', '4', '5', '9'}, // "2.71828182845" en TEXT
            [&]() {
        ...
        {
            "string",
            std::vector<qb::pg::byte>{'H', 'e', 'l', 'l', 'o', ',', ' ', 'P', 'o', 's', 't', 'g', 'r', 'e', 'S', 'Q', 'L', '!'},
            std::vector<qb::pg::byte>{'H', 'e', 'l', 'l', 'o', ',', ' ', 'P', 'o', 's', 't', 'g', 'r', 'e', 'S', 'Q', 'L', '!'}
        },
        ...
        {
            "unicode_string",
            std::vector<qb::pg::byte>{'U', 'n', 'i', 'c', 'o', 'd', 'e', ':', ' ', 
                static_cast<qb::pg::byte>(0xC3), static_cast<qb::pg::byte>(0xA4), 
                static_cast<qb::pg::byte>(0xC3), static_cast<qb::pg::byte>(0xB6), 
                static_cast<qb::pg::byte>(0xC3), static_cast<qb::pg::byte>(0xBC), ' ', 
                static_cast<qb::pg::byte>(0xE4), static_cast<qb::pg::byte>(0xBD), 
                static_cast<qb::pg::byte>(0xA0), static_cast<qb::pg::byte>(0xE5), 
                static_cast<qb::pg::byte>(0xA5), static_cast<qb::pg::byte>(0xBD), ' ', 
                static_cast<qb::pg::byte>(0xF0), static_cast<qb::pg::byte>(0x9F), 
                static_cast<qb::pg::byte>(0x98), static_cast<qb::pg::byte>(0x80)},
            std::vector<qb::pg::byte>{'U', 'n', 'i', 'c', 'o', 'd', 'e', ':', ' ', 
                static_cast<qb::pg::byte>(0xC3), static_cast<qb::pg::byte>(0xA4), 
                static_cast<qb::pg::byte>(0xC3), static_cast<qb::pg::byte>(0xB6), 
                static_cast<qb::pg::byte>(0xC3), static_cast<qb::pg::byte>(0xBC), ' ', 
        ...
        {
            "boolean_false",
            std::vector<qb::pg::byte>{'f', 'a', 'l', 's', 'e'},
        ...
        // String avec caractères spéciaux et nul
        {
            ...
            [&]() {
                ...
                return std::vector<qb::pg::byte>(special.begin(), special.begin() + special.size() + 1);
            }(),
            [&]() {
                std::string special = "Special\0Chars\r\n\t";
                return std::vector<qb::pg::byte>(special.begin(), special.begin() + special.size() + 1);
