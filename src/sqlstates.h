/**
 * @file sqlstates.h
 * @brief PostgreSQL SQLSTATE error codes definitions
 *
 * This file contains comprehensive definitions of PostgreSQL SQLSTATE error codes
 * organized by error class as specified in the SQL standard. These codes are used for:
 *
 * - Error reporting and identification
 * - Exception handling
 * - Standardized error classification
 * - Transaction status determination
 *
 * The codes follow the ANSI SQL and PostgreSQL convention where each error code
 * consists of a five-character string: a two-character class code followed by a
...
enum code {
    ...
    // string_data_right_truncation, /**< 22001 Duplicate of 01004 */
    ...
    // modifying_sql_data_not_permitted, /**< 38002 Duplicate of 2F002*/
    // prohibited_sql_statement_attempted, /**< 38003 Duplicate of 2F003 */
    // reading_sql_data_not_permitted, /**< 38004 of 2F004 */
    //@}
    //@{
    /** @name Class 39 — External Routine Invocation Exception */
    external_routine_invocation_exception, /**< 39000 */
    invalid_sqlstate_returned,             /**< 39001 */
    // null_value_not_allowed, /**< 39004 Duplicate of 22004 */
