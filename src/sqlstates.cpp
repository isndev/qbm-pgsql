/**
 * @file sqlstates.cpp
 * @brief Implementation of PostgreSQL SQLSTATE error codes mapping
 *
 * This file implements the mapping between PostgreSQL SQLSTATE error code strings
 * and their corresponding enumeration values. It provides:
 *
 * - A comprehensive mapping table from SQLSTATE string codes to enum values
 * - Implementation of the code_to_state function for error code lookups
 * - Organization of error codes following PostgreSQL's standard classification
 *
 * The implementation uses a static map to efficiently convert the five-character
 * SQLSTATE codes (as defined in the SQL standard) to their enumerated representation
 * in the codebase.
 *
 * @see sqlstates.h
